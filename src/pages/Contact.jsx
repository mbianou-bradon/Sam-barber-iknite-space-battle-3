...
export default function Contact(){
    ...
    return (
        <div>
            <div className="md:h-[75vh] md:mt-10">
                <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 [&>*]:place-self-center px-3 sm:px-0">
                        ...
                        <div className="w-4/5 ">
                            <form action="" className="[&>input]:border [&>input]:border-primary [&>input]:block [&>input]:h-10 [&>input]:w-full  [&>input]:text-sm [&>input]:text-primary [&>input]:rounded-lg [&>input]:my-2 [&>input]:pl-4 [&>label]:text-sm [&>label]:mt-5 [&>label]:block [&>label]:ml-2">
                                <label htmlFor="name">Name</label>
                                <input type="text" name="name" id="forName" placeholder="John Doe"/>

                                <label htmlFor="email">Institutional Email</label>
                                <input type="email" name="email" id="forEmail" placeholder="johndoe@example.com" />

                                <label htmlFor="subject">Subject</label>
                                <input type="text" name="subject" id="forSubject" />

                                <label htmlFor="message">Message</label>
                                <textarea name="message" id="forMessage" rows="5" placeholder="Write your message here. . ." className="block border border-primary rounded-lg resize-none p-4 my-2 text-sm w-full"></textarea>
